						...
						<div id="pay-invoice">
							<div class="card-body">
								<form action="Save_Edit_Company.php" method="post" onsubmit="return CheckValue();" novalidate="novalidate">
									...
									<div>
										<button id="button" type="submit" class="btn btn-sm btn-info btn-block" name="save" onclick="return CheckValue2()" value="submit"><i class="fa fa-edit"></i>&nbsp; Submit Company Infos</button>
									</div>
								</form>
							</div>
						</div>
