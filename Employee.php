							...
							<div class="card-body">
								<form action="save_employee.php" method="post" onsubmit="return validmail()" enctype="multipart/form-data" id="employee_form">
									...
									<div class="row">
										...
										<div class="col-3">
											<div class="form-group">
												<label for="employee_marital_status" class=" form-control-label">Employee Working Status *</label>
...
<script>
	function CheckValue(sender){
		...
		var stat = document.getElementById('employee_status').value;
	...
	function CheckValue2(){
		...
		if(stat=="0"){
			swal('Please select Working Status !', '', 'warning')
			return false;
		}
		if(join==""){
		...
		if(cont.length != 10){
			swal('mobile number contains 10 digits in Gambia', '', 'warning');
			document.getElementById('employee_contNum').value='';
			return false;
		}
