							...
							<?php
								...
								<tbody id="myTable">
									<tr>
										...
										<td width="15%" ><?php echo $row["Basic_Salary"]; ?>.00 dalasi</td>
										<td width="10%" ><?php echo $row["House_rent"]; ?>.00 dalasi</td>
										<td width="10%" ><?php echo $row["Medical"]; ?>.00 dalasi</td>
										<td width="10%" ><?php echo $row["Transport"]; ?>.00 dalasi</td>
										<td width="13%"><?php echo $row["vat"]; ?>.00 dalasi</td>
										<td width="15%"><?php echo $row["total_salary"]; ?>.00 dalasi</td>
