...
<html class="no-js" lang=""> <!--<![endif]-->
	<head>
		...
		<title>Sky High Group Ltd.</title>
			...
			<div class="container">
				<div class="login-content">
					<div class="login-form">
						<h2><center><?php echo $row['company_name']; ?> Company User</center></h2><hr/>
						<center><img src="skypic.jpeg" alt="sky high" width="300" height=150></center>
						<hr/>
							...
							<form  method="POST">
								...
								<div class="checkbox">
									...
									<label class="pull-right">
										...
										<p>Sky High Group Ltd. &copy; - 2020</p>
									</label>
								</div>
