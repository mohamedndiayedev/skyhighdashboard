...
<?php
    ...
    if(isset($_POST['save'])){
        ...
        else
        {
            ...
            $sql = "INSERT INTO employee_info (employee_id, employee_name, employee_type, employee_gender, 
			employee_dept,employee_desgn, employee_pay, employee_idno,employee_dob,employee_status,employee_joindate,newName,employee_contNum,employee_email, 
			employee_ref, employee_marital_status, employee_nid, employee_passportid,employee_emg_contNum, father_name,mother_name,present_address,permanent_address) VALUES 
			('$employee_id','$employee_name','$employee_type','$employee_gender',
			'$employee_dept','$employee_desgn','$employee_pay','$employee_idno',
			'$employee_dob','$employee_status','$employee_joindate','$newName','$employee_contNum',
