<?php 
	...
	if(isset($_POST['update'])){
		...
		$emp_ref =$_POST['employee_ref']; 
		$emp_type =$_POST['employee_type'];
		$emp_pasid =$_POST['employee_passportid'];
		$emp_marital_status = $_POST['employee_marital_status']; 
		$emp_jd = $_POST['employee_joindate'];
		$emp_nid = $_POST['employee_nid'];
		$emp_emg = $_POST['employee_emg_contNum'];
		...
		employee_dob= '$emp_dob' , employee_contNum= '$emp_contNum' ,employee_ref='$emp_ref', employee_type='$emp_type',
		employee_passportid='$emp_pasid',employee_marital_status= '$emp_marital_status',employee_joindate='$emp_jd',
		employee_nid= '$emp_nid' , employee_emg_contNum='emp_emg', present_address= '$pre_address', permanent_address= '$perm_address',
							...
							<div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
								<div class="row" >
									<div class="col-md-3">										
										...
										<p><i class="fa fa-phone"></i>&nbsp; Mobile : +220<?php  echo $row['employee_contNum']; ?></p>
									...
									<div class="col-md-9">
										<div class="card-body">
											<table class="table">
												...
												<tbody>
												<tr>
														<td><i class="fa fa-user fa-user"></i>&nbsp; Name</td>
														<td> : </td>
														<td><?php  echo $row['employee_name']; ?></td>
													</tr>
													<tr>
														<td><i class="fa fa-male fa-male"></i>&nbsp; Gender</td>
														<td> : </td>
													...
													<tr>
														<td><i class="fa fa-user"></i>&nbsp; Type</td>
														<td> : </td>
													...
													<tr>
														<td><i class="fa fa-phone"></i>&nbsp; Contact Number</td>
														<td> : </td>
									...
									<div class="col-md-5">
										<table class="table">
											...
											<tbody>
												<tr>
													<td>Basic Salary</td>
													<td><?php  echo $row['Basic_Salary']; ?>.00 Dalasi</td>
												</tr>
												<tr>
													<td>House Rent Allowance</td>
													<td><?php  echo $row['House_rent']; ?>.00 Dalasi</td>
												</tr>
												<tr>
													<td>Medical Allowance </td>
													<td><?php  echo $row['Medical']; ?>.00 Dalasi</td>
												</tr>
												<tr>
													<td>Transport Allowance </td>
													<td><?php  echo $row['Transport']; ?>.00 Dalasi</td>
												</tr>
												<tr>
													<th>Sub Total </th>
													<th><?php echo $row['Basic_Salary']+$row['House_rent']+$row['Medical']+$row['Transport']; ?>.00 Dalasi</th>
												</tr>
												<tr>
													<td>Vat </td>
													<td><?php  echo $row['vat']; ?>.00 Dalasi</td>
												</tr>
												<tr>
													<th>Total Salary</th>
													<th><?php  echo $row['total_salary']; ?>.00 Dalasi</th>
												</tr>
											</tbody>
										</table>
									</div>
									...
									<form method="POST">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="row">
													<div class="col-4">
														<label class=" form-control-label"><i class="fa fa-male fa-male"></i>&nbsp; Gender</label>
													</div>
													<div class="col-8">
														<div class="form-group">
															<input type="text" name="employee_gender" id="employee_gender" value="<?php echo $row['employee_gender']; ?>"class="form-control">
														</div>
													</div>													
												</div>
												<div class="row">
												...
												<div class="row">
													...
													<div class="col-8">
														<div class="form-group">
															<input type="text" name="employee_ref" id="employee_ref" value="<?php echo $row['employee_ref']; ?>"class="form-control">
														</div>
													</div>													
												</div>
												<div class="row">
											...
											<div class="col-md-6">
												<div class="row">
													...
													<div class="col-8">
														<div class="form-group">
															<input type="text" name="employee_type" id="employee_type" value="<?php echo $row['employee_type']; ?>"class="form-control" >
														</div>
													</div>													
												</div>
												<div class="row">
													...
													<div class="col-8">
														<div class="form-group">
															<input type="text" name="employee_email" id="employee_email" value="<?php echo $row['employee_email']; ?>"class="form-control" >
														</div>
													</div>													
												</div>
												<div class="row">
													...
													<div class="col-8">
														<div class="form-group">
															<input type="text" name="employee_joindate" id="employee_joindate" value="<?php echo $row['employee_joindate']; ?>"class="form-control" >
														</div>
													</div>													
												</div>
												<div class="row">
